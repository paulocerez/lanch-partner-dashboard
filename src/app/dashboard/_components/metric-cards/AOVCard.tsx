  ...
  return (
    <Card>
      ...
      <Metric>{
        vendorIds.length > 0 ?       
        (
          parseFloat(data?.api_partner_dashboard_api_pd_food_orders_aggregate?.aggregate.sum.gmv || "0") /
          parseInt(data?.api_partner_dashboard_api_pd_food_orders_aggregate?.aggregate.count || "0")
