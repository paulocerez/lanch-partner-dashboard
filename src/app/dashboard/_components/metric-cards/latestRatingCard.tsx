...
query getRatingsQuery(
  ...
  api_partner_dashboard_api_pd_vendor_display_ratings_latest(where: {vendor_id: {_in: $_vendor_ids}, order_platform_name: {_in: $_order_source_names}}) {
    vendor_id
    order_platform_name
    rating_display
    rating_count
...
`;
  ...
  if (data?.api_partner_dashboard_api_pd_vendor_display_ratings_latest) {
    display_data = calculateRatingPerVendor(data?.api_partner_dashboard_api_pd_vendor_display_ratings_latest)
  } 
