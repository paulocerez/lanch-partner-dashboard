...
import VendorItemComponent from "./(components)/vendorItem";
            ...
            <div className="flex items-start md:items-center pt-6 flex-col md:flex-row">
              ...
              <div className="md:w-80 md:mx-6 space-y-6 w-auto mt-4 md:mt-0">
                <MultiSelect value={selectedVendors} onValueChange={setSelectedVendors}>
                  {/* {vendors.map((vendor) => (
                    <VendorItemComponent key={vendor.value} vendorId={vendor.value} vendorName={vendor.name}/>
                  ))} */}
                  <MultiSelectItem value="DE_Berlin_001">
                    HS Berlin Mitte
                  </MultiSelectItem>  
                  <MultiSelectItem value="DE_Berlin_001">
                    HS Berlin Friedrichshain
                  </MultiSelectItem>  
                  <MultiSelectItem value="DE_Berlin_001">
                    HS Berlin Prenzlauer Berg
                  </MultiSelectItem>  
                  <MultiSelectItem value="DE_Berlin_001">
                    HS Berlin Kreuzberg
                  </MultiSelectItem>  
