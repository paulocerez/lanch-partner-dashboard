...
const getTotalGMVQuery = gql`
  query getTotalGMV(
    ...
    $_fromDate: Timestamp = "2023-07-15"
    ...
    api_partner_dashboard_api_pd_food_orders_aggregate(
      where: {
        ...
        _and: { ordered_at: { _gte: $_fromDate } }
        ordered_at: { _lte: $_toDate }
      }
    ) {
      aggregate {
        count
...
export default function Home() {
  ...
  let MultiSelectItemArray = data?.api_partner_dashboard_api_pd_food_orders.map(
    (vendor) => (
